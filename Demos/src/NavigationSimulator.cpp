                             ...
                             double maxSpeed)
{
  ...
  {
    osmscout::RouteDescription::MaxSpeedDescriptionRef maxSpeedPath=currentNode->GetDescription<osmscout::RouteDescription::MaxSpeedDescription>(osmscout::RouteDescription::WAY_MAXSPEED_DESC);
