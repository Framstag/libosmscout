...
LineEdit {
    ...
    property int dialogX;
    property int dialogY;
    ...
    Item {
        ...
        function showPopup() {
            ...
            console.log("Root: " + root.x +"," +root.y +" "+root.width+"x"+root.height);
            console.log("LocationEdit: " + locationEdit.x +"," +locationEdit.y +" "+locationEdit.width+"x"+locationEdit.height);
            console.log("Original window position: " + dialogX + "," + dialogY);

            console.log(locationEdit.y +" "+locationEdit.parent.y + " " + locationEdit.parent.parent.y)

            var rootedXY = locationEdit.mapFromItem(locationEdit,0,locationEdit.x+locationEdit.height);

            console.log("Rooted position: " + rootedXY.x+","+rootedXY.y);

            var locationEditXY=mapFromItem(locationEdit,dialogX,dialogX);

            console.log("Effective window position: " + locationEditXY.x + "," + locationEditXY.y);

            /*
            suggestionBox.x = locationEditXY.x
            suggestionBox.y = locationEditXY.y
*/
            suggestionBox.x = dialogX;
            suggestionBox.y = dialogY;
            suggestionBox.width = dialogWidth;
            suggestionBox.height = dialogHeight;
