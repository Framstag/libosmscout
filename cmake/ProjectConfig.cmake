...
macro(osmscout_library_project)
	...
	if(EXISTS ${_template})
		if(NOT _feature)
			...
			set(_feature ${CMAKE_CURRENT_BINARY_DIR}/include/osmscout/${_template_name}.h)
		endif()
		configure_file(${_template} ${_feature})
		install(FILES ${_feature} DESTINATION include/osmscout)
	endif()
	...
	if(NOT ${_skip_header})
		if(NOT _exclude)
			...
			install(DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}/include/osmscout DESTINATION include FILES_MATCHING PATTERN "*.h" PATTERN "private" EXCLUDE PATTERN ${_exclude} EXCLUDE)
		endif()
	endif()
