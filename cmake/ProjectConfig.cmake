...
macro(osmscout_test_project)
	...
	if(NOT _skiptest)
		...
		if(WIN32)
			# Ensure Qt and osmscout DLLs are on PATH for the test
			set(qt_bin "")
			if(QT_FOUND AND TARGET Qt::qmake)
				...
				set(qt_bin ";${qt_install_prefix}\\bin")
			endif()
			set(envpath "PATH=$<TARGET_FILE_DIR:OSMScout>${qt_bin}")
		...
		if(MSVC)
			...
			set(envpath_user "PATH=${envpath_user}\\$(Configuration)${qt_bin}")
			foreach(tg IN LISTS OSMLIBS)
				if(TARGET ${tg})
