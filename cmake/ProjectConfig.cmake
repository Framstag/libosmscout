...
macro(osmscout_test_project)
	...
	if(NOT _skiptest)
		...
		if(MINGW)
			get_target_property(OSMSCOUT_DIR OSMScout BINARY_DIR)
			file(TO_NATIVE_PATH "${OSMSCOUT_DIR}" OSMSCOUT_DIR)
			set(envpath "PATH=${OSMSCOUT_DIR}")
			set(OSMLIBS OSMScoutMap OSMScoutMapSVG OSMScoutMapAGG OSMScoutMapQt OSMScoutMapCairo OSMScoutImport OSMScoutGPX OSMScoutClientQt OSMScoutTest)
			foreach(tg IN LISTS OSMLIBS)
				if(TARGET ${tg})
					get_target_property(TG_DIR ${tg} BINARY_DIR)
					file(TO_NATIVE_PATH "${TG_DIR}" TG_DIR)
					set(envpath "${envpath};${TG_DIR}")
				endif()
			endforeach()
