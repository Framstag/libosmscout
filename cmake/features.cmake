...
if(NOT MSVC)
  ...
  string(REGEX MATCH "(.*)-ARCH" OSMSCOUT_TEST_ARCH_LINUX ${CMAKE_SYSTEM_VERSION})
  if(OSMSCOUT_TEST_ARCH_LINUX)
    set(HAVE_SSE2 OFF)
    message(WARNING "SSE2 is not available on arch linux")
    message(WARNING "TODO: Fix SSEMath.cpp")
  endif()
  if(HAVE_SSE2)
