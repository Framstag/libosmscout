...
Distance UsualObjectSize(const QString &name)
{
  static const QMap<QString, Distance> sizeMap{
      ...
      {"place_province",        Kilometers(80)},
      {"place_peninsula",      Kilometers(80)},
      {"place_district",        Kilometers(50)},
      {"place_subdistrict",     Kilometers(30)},
      {"place_municipality",    Kilometers(20)},
      ...
      {"place_borough",        Kilometers(10)},
      {"place_quarter",        Kilometers(5)},
      {"place_neighbourhood",  Kilometers(3)},
      {"place_city",           Kilometers(10)},
      {"place_town",           Kilometers(6)},
      {"place_islet",          Kilometers(1)},
      {"place_hamlet",         Kilometers(1)},
      {"place_isolated_dwelling",Kilometers(1)},
      {"place_farm",           Kilometers(1)},
      {"place_allotments",     Kilometers(1)},
      {"place_locality",       Kilometers(1)},
      {"place_square",         Kilometers(0.5)},
      {"place_city_block",     Kilometers(1)},
      {"place_plot",           Kilometers(0.5)},
      {"place_archipelago",    Kilometers(150)},
      {"place_polder",         Kilometers(10)},
