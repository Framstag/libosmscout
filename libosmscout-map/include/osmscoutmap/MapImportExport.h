...
#include <osmscoutmap/MapFeatures.h.cmake>
...
#  ifdef OSMScoutMap_EXPORTS
#    define OSMSCOUT_MAP_API OSMSCOUT_EXPORT
#  else
#    define OSMSCOUT_MAP_API OSMSCOUT_IMPORT
#  endif
#  define OSMSCOUT_MAP_DLLLOCAL OSMSCOUT_LOCAL
#  else
...
#elif defined(OSMScoutMap_EXPORTS)
  #define OSMSCOUT_MAP_EXCEPTIONAPI(api) OSMSCOUT_EXPORT
#else
