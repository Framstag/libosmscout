...
void Scanner::Init() {
  ...
  eofSym = 0;
	...
	keywords.set("symbol", 54);
	keywords.set("symbolSpace", 55);
	keywords.set("name", 56);
	keywords.set("butt", 57);
	keywords.set("round", 58);
	keywords.set("square", 59);
	keywords.set("normal", 60);
	keywords.set("emphasize", 61);
	keywords.set("ref", 62);
	keywords.set("world", 63);
	keywords.set("continent", 64);
	keywords.set("state", 65);
	keywords.set("stateOver", 66);
	keywords.set("county", 67);
	keywords.set("region", 68);
	keywords.set("proximity", 69);
	keywords.set("cityOver", 70);
	keywords.set("city", 71);
	keywords.set("suburb", 72);
	keywords.set("detail", 73);
	keywords.set("close", 74);
	keywords.set("veryClose", 75);
	keywords.set("block", 76);
	keywords.set("mm", 77);
	keywords.set("m", 78);
