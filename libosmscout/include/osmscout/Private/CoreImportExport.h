...
#if defined(__WIN32__) || defined(WIN32)
  #define OSMSCOUT__EXCEPTIONAPI(api) api
#elif defined(OSMSCOUT__EXPORT_SYMBOLS)
  #define OSMSCOUT__EXCEPTIONAPI(api) OSMSCOUT__EXPORT
#else
  #define OSMSCOUT__EXCEPTIONAPI(api)
#endif

#if defined(_MSC_VER)
  #define OSMSCOUT__INSTANTIATE_TEMPLATES
#endif  
#endif
