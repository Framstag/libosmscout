...
void Scanner::Init() {
  ...
  eofSym = 0;
	...
	keywords.set("NODE", 8);
	keywords.set("KEY", 9);
	keywords.set("VALUE", 10);
	keywords.set("WAY", 11);
	keywords.set("PRIO", 12);
	keywords.set("AREA", 13);
	keywords.set("LINE", 14);
	keywords.set("WITH", 15);
	keywords.set("ALTCOLOR", 16);
	keywords.set("OUTLINECOLOR", 17);
	keywords.set("FILL", 18);
	keywords.set("PATTERN", 19);
	keywords.set("BORDER", 20);
	keywords.set("LABEL", 21);
	keywords.set("COLOR", 22);
	keywords.set("BGCOLOR", 23);
	keywords.set("BORDERCOLOR", 24);
	keywords.set("REF", 25);
	keywords.set("SYMBOL", 26);
	keywords.set("ICON", 27);
	keywords.set("STYLE", 28);
	keywords.set("none", 29);
	keywords.set("normal", 30);
	keywords.set("longDash", 31);
	keywords.set("dotted", 32);
	keywords.set("lineDot", 33);
	keywords.set("contour", 34);
	keywords.set("plate", 35);
	keywords.set("emphasize", 36);
	keywords.set("box", 37);
	keywords.set("triangle", 38);
	keywords.set("circle", 39);
	keywords.set("LAYER", 40);
	keywords.set("FILTER", 41);
	keywords.set("MINMAG", 42);
	keywords.set("MAXMAG", 43);
	keywords.set("FADE", 44);
	keywords.set("AT", 45);
	keywords.set("world", 46);
	...
	keywords.set("MINPIXEL", 59);
	keywords.set("WIDTH", 60);
	keywords.set("OUTLINE", 61);
