...
void Scanner::Init() {
  ...
  eofSym = 0;
	...
	keywords.set("FILL", 16);
	keywords.set("PATTERN", 17);
	keywords.set("BORDER", 18);
	keywords.set("LABEL", 19);
	keywords.set("COLOR", 20);
	keywords.set("BGCOLOR", 21);
	keywords.set("BORDERCOLOR", 22);
	keywords.set("REF", 23);
	keywords.set("SYMBOL", 24);
	keywords.set("ICON", 25);
	keywords.set("STYLE", 26);
	keywords.set("none", 27);
	keywords.set("normal", 28);
	keywords.set("longDash", 29);
	keywords.set("dotted", 30);
	keywords.set("lineDot", 31);
