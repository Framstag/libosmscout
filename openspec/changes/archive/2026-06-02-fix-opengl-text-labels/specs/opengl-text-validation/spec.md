...
- **THEN** application exits with error code 1 and prints error message containing "Font file" and "does not exist"

#### Scenario: Directory path rejected
- **WHEN** user provides `--fontName /usr/share/fonts/` (a directory, not a file)
- **THEN** application exits with error code 1 and prints error message
...
- **THEN** application exits with error code 1 and prints error message about invalid font size
