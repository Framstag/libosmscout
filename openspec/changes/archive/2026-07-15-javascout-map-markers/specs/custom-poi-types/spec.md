...
- **WHEN** `withCustomPoiType("_favorite")`, `withCustomPoiType("_search_selected")`, and `withCustomPoiType("_route_start")` are chained
- **THEN** the builder SHALL store all three type names in order
