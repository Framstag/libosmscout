# javascout-responsive-shell

Responsive layout, positioning, and keyboard navigation for JavaScout overlay panels.

## Purpose

Ensure search and route panels adapt to window size and display scale, stay within the visible scene, and can be operated via keyboard.
