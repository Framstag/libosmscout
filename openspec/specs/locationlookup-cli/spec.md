# locationlookup-cli Specification

## Purpose
The command-line surface and output format of the LocationLookup demo. New flags for source selection, search center, and weight overrides; the verbose dump is replaced by a compact table that keeps per-field match qualities, admin region hierarchy, and timing.
