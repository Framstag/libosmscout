...
Register, load, and select map providers that expose available map listings and downloadable map data. Providers are identified by a unique name and carry the base URI and list-URI template needed by clients to fetch map metadata.
