...
Maintain a persistent off-screen image buffer for map rendering. Render into it asynchronously. On completion, swap to front buffer and blit to JavaFX Canvas. Eliminates flicker and allows UI thread to always display a complete frame.
