...
Persist the last map view position (latitude, longitude, magnification) across application restarts. Save on view change with debounce, restore on startup with fallback defaults.
