# search-dedup Specification

## Purpose
Deduplicate near-identical search results, matching OSMScout2's `equals` logic: same object type, less than 300 m apart, and more than 3000 m from the search center.
