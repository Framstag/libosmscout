...
Show a highly visible marker on the JavaScout map for the currently selected search result, both as a preview while browsing results and as a persistent marker after navigating to the result.
