...
The Skia map backend SHALL maintain a `TODO.md` file documenting features still missing compared to the Cairo and Qt backends, providing visibility into remaining work.
