# test-conversion-asyncprocessing

## Purpose

Convert the legacy AsyncProcessingTest (uses custom main() with cout-based verification) to Catch2 TEST_CASE macros and REQUIRE assertions.

## Requirements

### Requirement: Async processing test runs under Catch2

The AsyncProcessingTest SHALL use Catch2 TEST_CASE macros and REQUIRE assertions vs a custom main() with cout-based verification.
...
#### Scenario: Multi-vector worker across 4 workers
